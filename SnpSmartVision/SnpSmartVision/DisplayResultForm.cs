    ...
    public partial class DisplayResultForm : Form
    {
        ...
        private void WmNCCalcSize(ref Message m)
        {
            ...
            if (m.WParam != IntPtr.Zero)    //TRUE
            {
                ...
                nccsp.rgrc0.bottom -= 3;    //4-pixel bottom (resize) border
                nccsp.rgrc0.left += 3;      //4-pixel left (resize) border
                nccsp.rgrc0.right -= 3;     //4-pixel right (resize) border
            ...
            else    //FALSE
            {
                ...
                //Adding to the Top, Bottom, Left, and Right will size the client area.
                clnRect.top += 3;      //30-pixel top border
                clnRect.bottom -= 3;    //4-pixel bottom (resize) border
                clnRect.left += 3;      //4-pixel left (resize) border
                clnRect.right -= 3;     //4-pixel right (resize) border
        ...
        {
            //Clear
            e.Graphics.Clear(Color.SeaGreen);
        }
